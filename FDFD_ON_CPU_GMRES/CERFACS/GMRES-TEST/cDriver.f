...
*****************************************
*
10     call drive_cgmres(n,n,m,lwork,work,
...
*         work(colz) <-- M^{-1} * work(colx)
         ...
         call ctrsm('L','L','N','N',n,1,ONE,A,lda,work(colz),n)
         goto 10
*
       else if (revcom.eq.precondRight) then
* perform the right preconditioning
         call ccopy(n,work(colx),1,work(colz),1)
         call ctrsm('L','U','N','N',n,1,ONE,A,lda,work(colz),n)
         goto 10
*
...
*
      nout = 11
      open(nout,FILE='sol_cTest',STATUS='unknown')
